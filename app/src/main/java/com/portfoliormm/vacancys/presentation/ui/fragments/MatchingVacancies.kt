 ...
 * Use the [MatchingVacancies.newInstance] factory method to
 * create an instance of this fragment.
 */
class MatchingVacancies : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MatchingVacancies.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MatchingVacancies().apply {
